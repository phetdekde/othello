    ...
    return (
        <>
            <div className="join-room-div">
                ...
                <button className='button' disabled={isJoining} onClick={(e) => {joinRoom(e, roomName, true)}}>{isJoining ? 'Creating...' : 'CREATE'}</button>
                <button className='button' disabled={isJoining} onClick={(e) => {joinRoom(e, roomName, false)}}>{isJoining ? 'Joining...' : 'JOIN'}</button>
            </div>
